...
import 'package:get_test/features/home/data/models/user_model.dart';
import 'package:get_test/features/home/data/repositories/user_repository_impl.dart';
...
void main() {
  ...
  test('should return a list of UserModel', () async {
    ...
    expect(result.fold(id, id), isA<UserRepositoryFailure>());
  });
}
